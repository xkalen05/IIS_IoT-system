    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="reserve_device_{{$system->id}}_modal">Add device to the system</h1>
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('user.device.reserve') }}">
                    ...
                    <div class="mb-3">
                        <label for="user-checkbox">Select device that you want to add to your system:</label>
