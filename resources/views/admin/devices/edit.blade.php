    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('admin.device.edit') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{$device->description}}" class="form-control" id="description" name="description" placeholder="description">
                    </div>
                    <div class="mb-3">
                        <a>*required field</a>
                    </div>
